...
{
    public class CRMBulkFacebookECFLeads
    {
        public void UpdateCRMLeadStatusForBulkFacebookECFLeads(DateTime fromDate, DateTime toDate)
        {
            ...
            try
            {
                ...
                var dbData = db.CRMFacebookECFLeads
                ...
                {
                    LogException.Log("BergerLeadCRMSchedular.DB BergerLeadCRMSchedular.DB CRMBulkFacebookECFLeads.UpdateCRMLeadStatusForBulkFacebookLeads :  Not data found in Database.");
                    return;
                }
                ...
                foreach (var getlist in dbData)
                {
                    ...
                    try
                    {
                        ...
                        var facebookleadquery = db.CRMFacebookECFLeads
                        ...
                        if (facebookleadquery != null)
                        {
                            ...
                            {
                                LogException.Log(string.Format("{0},{1},{2},{3}", "Exception in BergerLeadCRMSchedular.DB CRMBulkFacebookECFLeads.UpdateCRMLeadStatusForBulkFacebookLeads : ", status, leadDetail.Id, ex.Message));
                            }
                        }
                    }
                    catch (Exception ex)
                    {
                        LogException.Log(string.Format("CRMBulkFacebookECFLeads splitData exception : .{0}", ex.Message));
                    }
            ...
            {
                LogException.Log(string.Format("{0},{1}", "Exception in BergerLeadCRMSchedular.DB CRMBulkFacebookECFLeads.UpdateCRMLeadStatusForBulkFacebookLeads : ", ex.Message));
            }

            LogException.Log("CRMBulkFacebookECFLeads Updated.");
